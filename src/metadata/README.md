 ...
 * [noes.yml](noes.yml)
     * Determines how your purl.obolibrary.org/obo/noes/ redirects will be handled
     ...
     * Paste in the contents of [noes.yml](noes.yml)
 ...
 * [noes.md](noes.md)
     ...
     * Paste in the contents of [noes.md](noes.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
